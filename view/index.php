...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../plantilla/dist/img/ACAP.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">ACAP</span>
    </a>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                  ...
                  <a onclick="cargar_contenido('contenido_principal','tramite/view_tramite.php')" class="small-box-footer">
                    Mantenimiento de Tablas <i class="fas fa-arrow-circle-right"></i>
                  </a>
                </div>
            </div>
            <?php 
